...
public interface DepartmentRepository extends JpaRepository<Department, Long> {
	...
	@Query("SELECT new com.erp.hrms.entity.helper.PersonalInfoDTO(d.departmentId, d.departmentName, "
			...
			+ "pi.phoneCode, pi.personalContactNo, pi.email,  " + " jd.postedLocation) " + "FROM Department d "
			+ "JOIN d.personalInfos pi " + "LEFT JOIN pi.jobDetails jd " + "WHERE d.departmentName = :departmentName")
